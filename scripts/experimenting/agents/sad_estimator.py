...
class SadposeEstimator(BaseModule):
    ...
    def _build_model(self):
        in_cnn = SadposeEstimator._get_feature_extractor(
            self.model,
        ...
        self._model = get_sadpose_model(params)
